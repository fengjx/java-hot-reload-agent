...
import com.fengjx.reload.core.util.matcher.Matcher;
import com.fengjx.reload.core.util.matcher.RegexMatcher;
import com.fengjx.reload.core.util.matcher.WildcardMatcher;
...
public class SearchUtils {
    ...
    public static Set<Class<?>> searchClass(Instrumentation inst, String classPattern, boolean isRegEx) {
        ...
        return AgentConfig.isDisableSubClass() ? searchClass(inst, classNameMatcher) :
    ...
    public static Matcher<String> classNameMatcher(String classPattern, boolean isRegEx) {
        if (StrUtils.isEmpty(classPattern)) {
            classPattern = isRegEx ? ".*" : "*";
        }
        if (!classPattern.contains("$$Lambda")) {
            classPattern = StrUtils.replace(classPattern, "/", ".");
        }
